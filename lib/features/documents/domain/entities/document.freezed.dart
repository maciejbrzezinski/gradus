...
mixin _$Document {
  String get id;
  DateTime? get date; // nullable dla projektów
  String? get title; // dla projektów
  String? get icon; // dla projektów
  String? get iconColor; // dla projektów
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, date, title, icon, iconColor,
